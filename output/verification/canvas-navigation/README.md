...
- `doc-check-release.log`: PASS after final verification documentation; reports are generated in fresh directories. Earlier `doc-check-2.log` is retained as an earlier result.
