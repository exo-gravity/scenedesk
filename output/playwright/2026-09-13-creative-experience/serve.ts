/** Synthetic isolated E2E: actual API/PG/MinIO/upload processing; zero generation executors. */
...
const evidence = resolve(
  "output/playwright/2026-09-13-creative-experience",
  runId,
);
...
async function start() {
  ...
  const f = await businessFixture(context, async (db) => {
    ...
    try {
      ...
      for (const role of [db.apiRole, mediaRole])
  ...
  const fixture = {
    ...
    providerCalls: 0,
    generationExecutorStarted: false,
  };
