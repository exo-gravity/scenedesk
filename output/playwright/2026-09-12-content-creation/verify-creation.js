async (page) => {
  ...
  for (const kind of ["episode", "scene", "shot"]) {
    ...
    await page.screenshot({
      path: `output/playwright/2026-09-12-content-creation/${kind}-unknown-restored.png`,
      animations: "disabled",
    });
    await dialog
  ...
  await dialog
    ...
    .waitFor();
  await page.screenshot({
    path: "output/playwright/2026-09-12-content-creation/committed-cleanup-failed.png",
    animations: "disabled",
  });
