...
| PR-09 | GET | `/v1/tenants/{tenantId}/projects/{projectId}/scenes/{sceneId}/selected-delivery` | `previewSelectedDelivery` | `project_member` |
| PR-09 | POST | `/v1/tenants/{tenantId}/projects/{projectId}/scenes/{sceneId}/selected-delivery/download` | `downloadSelectedDelivery` | `project_member` |
