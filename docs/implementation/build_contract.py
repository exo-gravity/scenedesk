...
schema("ReworkLink", {"reviewId": ID, "commentId": ID}, ["reviewId","commentId"])
...
require_when("AssistanceRequest", {"properties":{"kind":{"const":"prepare_rework"}},"required":["kind"]}, {"required":["feedback"],"anyOf":[{"required":["sourceTakeId"]},{"required":["sourceCutRevisionId"]}]})
