...
| E01 身份、权限与内容基础 | 实施中 | [身份／项目基础](23-identity-project-foundation.md)已贯通真实数据库、OIDC、权限、CAS、幂等和业务页面，并完成本地验证；集场镜内容层待实施，远端 CI／合入记录随后补充 |
| E02 剧本、结构与提案 | 待实施 | 手工及 CSV 录入、正式依据、追加与重复采纳保护 |
