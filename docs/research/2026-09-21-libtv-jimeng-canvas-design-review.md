...
SceneDesk 已有「继续创作」：选定已有文字或媒体，打开来源确认面板，选择图片／视频／声音草稿，系统在来源右侧建立新草稿和有序引用。多项素材可共同作为参考。它并不缺少这条业务路径。[继续创作实现](../../apps/web/src/business/CanvasContinueCreation.tsx)、[派生逻辑](../../apps/web/src/business/canvas-creation.ts)
