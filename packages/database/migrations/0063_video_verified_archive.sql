-- Actual integer timing is retained. The fixed technical profile allows at most one decoded frame of container quantization.
...
BEGIN
 ...
 END IF;
 media_kind:=CASE WHEN s.source->>'mime'='video/mp4' THEN 'video' ELSE 'image' END;
