...
function scheme(tone: "light" | "dark") {
  ...
  return {
    ...
    // The rebuilt creative workspace: SceneDesk's palette in LibTV's roles, so
    // that adopting another look later is one set of values, not a restyle.
    "--ws-studio-canvas": p.canvas,
    "--ws-studio-dot": p.dot,
    "--ws-studio-chrome": p.surface,
    "--ws-studio-chrome-border": p.line,
    "--ws-studio-card": p.surface,
    "--ws-studio-card-border": p.line,
    "--ws-studio-card-selected": p.selection,
    "--ws-studio-card-label": p.secondary,
    "--ws-studio-placeholder": p.field,
    "--ws-studio-submit": p.action,
    "--ws-studio-on-submit": p.onAction,
    "--ws-studio-shadow": p.shadow,
